...
public class MapActivity extends RosActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        visualizationView = (VisualizationView) findViewById(R.id.map_display);
        ...
        followMeToggleButton = (ToggleButton) findViewById(R.id.follow_me_button);
        enableFollowMe();
    }
    ...
    protected void init(NodeMainExecutor nodeMainExecutor) {
        ...
        NtpTimeProvider ntpTimeProvider =
                new NtpTimeProvider(InetAddressFactory.newFromHostString("192.168.0.101"),
