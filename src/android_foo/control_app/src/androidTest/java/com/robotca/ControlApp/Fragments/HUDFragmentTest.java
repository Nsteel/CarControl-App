...
public class HUDFragmentTest {
    ...
    static
    {
        ControlApp.ROBOT_INFO = new RobotInfo(null, "HUDTestRobotInfo", "HUDMasterURI", null,
                null, null, null, null, null, null, null, null, null, null, null, null, false, false, false, false);
    }
    ...
    public void testUpdateUI() throws Exception {
        ...
        hudFragment.updateUI(100.0, 360.0, 0.0, 0.0);
