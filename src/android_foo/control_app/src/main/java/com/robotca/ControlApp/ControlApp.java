...
import com.robotca.ControlApp.Fragments.TelemetryFragment;
...
public class ControlApp extends RosActivity implements ListView.OnItemClickListener,
    ...
    public static final String NOTIFICATION_TICKER = "Car Control";
    /** Notification title for the App */
    public static final String NOTIFICATION_TITLE = "Car Control";
...
//    }
    ...
    public void onPreferencesChanged(SharedPreferences prefs) {
        ...
        Log.d("ControlApp", "PreferencesChanged");
